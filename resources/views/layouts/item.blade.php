		...
		<div class="container">
			...
			<div class="wrap-breadcrumb">
				<ul>
					...
					<li class="item-link"><span>List Barang</span></li>
				</ul>
			</div>
			<div class="row">
							...
							<li class="col-lg-4 col-md-6 col-sm-6 col-xs-6 ">
								<div class="product product-style-3 equal-elem ">
									...
									<div class="product-info">
										<h4 style="font-family:courier;"><b>{{$barang->name}}</b></h4>
										<span>Deskripsi : <br>{{$barang->deskripsi}}</span> <br>
										<span>Nomor Penemu : {{$barang->nomor}}</span> <br>
										<span>Alamat ditemukan : {{$barang->alamat}}</span> <br>
										<a href="/items/{{$barang->id}}" class="btn add-to-cart" onclick="myFunction()">Ambil Barang</a>
										<script>
											function myFunction() {
											if (confirm("Jangan Lupa Menyimpan Nomor Telepon / HP Penemu!")) {
											} else {
											}
						...
						<div class="widget-content">
							<ul class="list-category">
								<li class="category-item has-child-cate">
									<a href="#" class="cate-link">Barang Elektronik</a>
								</li>
								<li class="category-item">
									<a href="#" class="cate-link">Peralatan & Perlengkapan</a>
								</li>
								<li class="category-item">
									<a href="#" class="cate-link">Mainan Anak</a>
								</li>
								<li class="category-item">
									<a href="#" class="cate-link">Lain - Lain</a>
								</li>
							</ul>
						</div>
